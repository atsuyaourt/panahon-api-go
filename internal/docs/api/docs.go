    ...
    "paths": {
        ...
        "/users/me/api-tokens": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create API token parameters",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateAPITokenReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.APITokenPermissions": {
            ...
            "properties": {
                ...
                "station_ids": {
                    "description": "null means all stations",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "variables": {
                    "description": "null means all variables",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
